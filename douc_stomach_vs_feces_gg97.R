...
for (L in 1:length(bT)) {
  ...
  pdf(paste0("results/gg97_stomach_feces/TaxaSummary_stomachvsfeces_L_gg97",bT[L],".pdf"),width = 8,height=7) # Make room for legend
  ...
  pdf(paste0("results/gg97_stomach_feces/TaxaSwarms_stomachvsfeces_L_gg97",bT[L],".pdf"),width = 6.5,height=6.5)
  sink(paste0("results/gg97_stomach_feces/Taxa_Significance_stomachvsfeces_L_gg97",bT[L],".txt"))   # Get ready to write the significant ones
  ...
  png(paste0("results/gg97_stomach_feces/Taxa_heatmap_stomachvsfeces_L_gg97",bT[L],".png"),  # create PNG for the heat map        
...
for (L in 1:length(bT)) {
  ...
  pdf(paste0("results/gg97_stomach_feces/TaxaSummary_stomachvsfeces_subject_L_gg97",bT[L],".pdf"),width = 8,height=7) # Make room for legend
  ...
  pdf(paste0("results/gg97_stomach_feces/TaxaSwarms_stomachvsfeces_subject_L_gg97",bT[L],".pdf"),width = 6.5,height=6.5)
  sink(paste0("results/gg97_stomach_feces/Taxa_Significance_stomachvsfeces_subject_L_gg97",bT[L],".txt"))   # Get ready to write the significant ones
  ...
  levels(gl)= c("red","green") # lscolors
  png(paste0("results/gg97_stomach_feces/Taxa_heatmap_stomachvsfeces_subject_L_gg97",bT[L],".png"),  # create PNG for the heat map        
      width = 8*300,                        # 8 x 300 pixels
      height = 6*300,
      res = 300,                              # 300 pixels per inch
      pointsize = 10)                          # smaller font size
